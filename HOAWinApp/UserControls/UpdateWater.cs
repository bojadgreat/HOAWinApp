                ...
                if (clientNameTB.Text != "")
                {
                    if (strCol.Contains(clientNameTB.Text))
                    {
                        ...
                        if (updateReading > currentTotalReading)
                        {
                            ...
                            UpData("UPDATE watercoldata SET FROM_DATE = '" + formattedDateFrom.ToUpper() + "' WHERE NAME = '" + divName + "';");
                            UpData("UPDATE watercoldata SET TO_DATE = '" + formattedDateTo.ToUpper() + "' WHERE NAME = '" + divName + "';");
